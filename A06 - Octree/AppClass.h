...
class Application
{
	...
	MyOctant* m_pRoot = nullptr; //root for octree
	uint m_uOctantID = -1; //Index of Octant to display
	uint m_uObjects = 0; //Number of objects in the scene
	uint m_uOctantLevels = 0; //Number of levels in the octree
	uint m_uOctantIdealE = 8; //Number of ideal entities in an octant
	bool displayTree = true;

private:
	String m_sProgrammer = "Kyle Fasanella - kmf7094@rit.edu"; //programmer
